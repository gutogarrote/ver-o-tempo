...
const TimeIndicator = ({ currentPercentage, currentTime, routineStartTime }) => {
  ...
  return (
    ...
    >
      {/* Current time display - highly visible with higher z-index */}
      <div 
        className="absolute -top-16 sm:-top-20 bg-slate-800 text-white px-3 py-1 sm:px-4 sm:py-2 rounded-lg shadow-2xl font-mono text-sm sm:text-base md:text-lg font-bold z-30"
        style={{ 
      ...
      {/* Glowing arrow/triangle marker - same colors as line */}
      <div 
